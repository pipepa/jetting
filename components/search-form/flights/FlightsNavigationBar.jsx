...
const FlightsNavigationBar = () => {
  ...
  return (
          ...
          <SwiperSlide key={index}>
            ...
            >
              <Link
                ...
                className="citiesCard -type-5 d-flex items-center bg-blue-1-05 shadow-new text-dark-1"
              >
                <i className="icon-aircraft text-22 text-rich-200"></i>
                <div className="ml-10 w-100">
                  <div className="fw-500 lh-15">{item.type}</div>
                  <div className="row">
                    ...
                    <div className="col-auto ms-lg-auto d-flex align-items-center">
                      <p className="text-12 lh-15">{formatMinutes(item.ticket.durationInMinutes, true)}, {outboundStops.length + inboundStopsLength}&nbsp;Stops</p>
                    </div>
                  </div>
                </div>
              </Link>
    ...
    <div className="d-flex x-gap-15 items-center justify-center pt-5 sm:pb-5">
      <div className="col-auto">
