    ...
    <div className="row mb-10">
      ...
      {checkboxes.length > itemsToShow && (
        <div className="col-auto ms-auto d-flex align-items-center">
          ...
          >
            Show {maxItems == checkboxes.length ? 'less' : 'more'}
          </button>
        </div>
      )}
    </div>
                ...
                <div className="col-10 pr-5">
                  <div className="form-checkbox d-flex items-center">
                    ...
                    <div className="ml-10">
                      ...
                      {filterItem.minPrice && (
                      <>
                        <div className={`text-12 lh-11 mb-5 ${filterItem.isCheapest ? ' fw-600 text-green-4' : `${filterItem.isBelowAverage ? 'fw-600 text-blue-1' : 'text-light-1'}`}`}>From: ${filterItem.minPrice}</div>
                      </>
                      )}
                    </div>
                  </div>
