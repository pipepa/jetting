    ...
    <>
      {deals.length ==  1 ? (
        <div className="col-auto">
          <a 
            className={`button flightDealsButton px-30 md:px-20 -dark-1 bg-dark-4 text-white`}
            href={`${deals[0].items[0].deepLink}`}
            target="_blank"
          >
            <span className="js-details-mainTitle md:text-12">
              Select
            </span>
            <div className="icon-arrow-top-right text-13 md:text-11 ml-15"></div>
          </a>
        </div>
      ) : (
        <>
                      ...
                      <a 
                        ...
                        <div className="col px-20">
                          <div className="text-16 fw-700 text-dark-1 px-20 md:px-10">
                            <span className="js-title">$&nbsp;{item.priceAmount}</span>
                          </div>
                        </div>
                        <div className="col px-20">
