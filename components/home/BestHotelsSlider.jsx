...
const BestHotelsSlider = ({ filterOption }) => {
  ...
  function ArrowSlick(props) {
    let className =
      props.type === "next"
        ? "slick_arrow-between slick_arrow -next arrow-md flex-center button -dark-1 bg-white shadow-1 size-30 rounded-full sm:d-none js-next"
        : "slick_arrow-between slick_arrow -prev arrow-md flex-center button -dark-1 bg-white shadow-1 size-30 rounded-full sm:d-none js-prev";
    className += " arrow";
    const char =
      props.type === "next" ? (
        <>
              ...
              <div className="hotelsCard__image">
                <div className="cardImage inside-slider">
                  ...
                  {/* <div className="cardImage__wishlist">
                    <button className="button -dark-1 bg-white size-30 rounded-full shadow-2" type="button">
